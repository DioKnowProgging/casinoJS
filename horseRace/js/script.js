...
function createTrack(choose) {
    for (let i = 47; i > 40; i--){
        ...
        trackField.innerHTML += `
            <img src="./pictures/${getCardString(deck[i])}.png">
        `;
...
function showSecondDeck(){
    ...
    secondDeckField.innerHTML = `
        <img src="./pictures/${getCardString(card)}.png">
    `;
}
